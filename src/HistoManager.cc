...
void HistoManager::Book()
{
  ...
  const G4String title[] =
		  ...
		  "number of e- created between Sensor 1 and Sensor 2", 	 //49
                  ...
                  "pure resolution of the first plane of 2S in x-direction",     //199
                  "pure resolution of the first plane of 2S in y-direction",     //200
                  "pure resolution of the second plane of 2S in x-direction",    //201
                  "pure resolution of the second plane of 2S in y-direction",    //202
