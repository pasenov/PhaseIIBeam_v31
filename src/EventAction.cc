...
void EventAction::EndOfEventAction(const G4Event* evt)
{
 ...
 for (G4int k = 0; k < 1017; k++) {
   ...
   if (fCS1a >= 5000)  {
      ...
      fChargeStrip1 = fChargeStrip1 + fCS1a;
      totalNbHitStrips++;
   }
   if (fCS1b >= 5000)  {
      ...
      fChargeStrip1 = fChargeStrip1 + fCS1b;
      totalNbHitStrips++;
   }
   if (fCS2a >= 5000)  {
      ...
      fChargeStrip2 = fChargeStrip2 + fCS2a;
      totalNbHitStrips++;
   }
   if (fCS2b >= 5000)  {
      ...
      fChargeStrip2 = fChargeStrip2 + fCS2b;
      totalNbHitStrips++;
   }
 }
 ...
 for (G4int k = 0; k < 1017; k++) {
  ...
  if (fCS1a >= 5000)  {
      fWeightStrip1a[k] = fCS1a/fChargeStrip1;
      ...
      fPointDet1ent = fPointDet1ent + G4ThreeVector((fStripCenterX*fCS1a/fChargeStrip1), (fStripCenterY*fCS1a/fChargeStrip1), (fStripCenterZ*fCS1a/fChargeStrip1));
   ...
   if (fCS1b >= 5000)  {
      fWeightStrip1b[k] = fCS1b/fChargeStrip1;
      ...
      fPointDet1ent = fPointDet1ent + G4ThreeVector((fStripCenterX*fCS1b/fChargeStrip1), (fStripCenterY*fCS1b/fChargeStrip1), (fStripCenterZ*fCS1b/fChargeStrip1));
   ...
   if (fCS2a >= 5000)  {
      fWeightStrip2a[k] = fCS2a/fChargeStrip2;
      ...
      fPointDet2ent = fPointDet2ent + G4ThreeVector((fStripCenterX*fCS2a/fChargeStrip2), (fStripCenterY*fCS2a/fChargeStrip2), (fStripCenterZ*fCS2a/fChargeStrip2));
   ...
   if (fCS2b >= 5000)  {
      fWeightStrip2b[k] = fCS2b/fChargeStrip2;
      ...
      fPointDet2ent = fPointDet2ent + G4ThreeVector((fStripCenterX*fCS2b/fChargeStrip2), (fStripCenterY*fCS2b/fChargeStrip2), (fStripCenterZ*fCS2b/fChargeStrip2));
